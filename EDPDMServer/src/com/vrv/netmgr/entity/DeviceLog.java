...
public class DeviceLog extends BaseEntity {
    /** 序列化ID */
    private static final long serialVersionUID = -2112715127218873227L;
    /** logType */
    ...
    /**
     * @param protectEndTime
     *            the protectEndTime to set
     */
